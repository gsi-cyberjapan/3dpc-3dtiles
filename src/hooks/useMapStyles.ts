...
const DEFAULT_MAP_STYLES: MapStyle[] = [
    ...
    { id: "pale-3d", name: "淡色地図", style: `/3dpc-3dtiles/styles/pale.json`, icon: "/3dpc-3dtiles/images/pale.png", deletable: false },
    {
        id: "skeleton",
        name: "白地図",
        style: `/3dpc-3dtiles/styles/skeleton.json`,
        icon: "/3dpc-3dtiles/images/skeleton.png",
        deletable: false,
    },
    {
        id: "english",
        name: "English",
        style: `/3dpc-3dtiles/styles/std-english.json`,
        icon: "/3dpc-3dtiles/images/std-english.png",
        deletable: false,
    },
    {
        id: "seamlessphoto",
        name: "写真",
        style: "/3dpc-3dtiles/styles/seamlessphoto.json",
        icon: "/3dpc-3dtiles/images/seamlessphoto.png",
        deletable: false,
    },
];
